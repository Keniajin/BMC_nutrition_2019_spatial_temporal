#######################################################This code is for plotting the temporal graphs for the repeated admissions#######################################################
#######################################################we fit the model in a loop for each admission and also as a temporal effect on INLA####################################################### 
#######################################################Author: KM Wambui ####################################################### 
