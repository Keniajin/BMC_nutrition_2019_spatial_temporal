#######################################################This code is for running the BUGS model from R#######################################################
#######################################################we load the data from CSV and send to open bugs####################################################### 
#######################################################Author: KM Wambui ####################################################### 
...
###reading in the Kilifi shape file
...
## get the the below adjacency matrix after loading the Splus map
